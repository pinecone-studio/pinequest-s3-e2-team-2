    ...
    <div className="p-6 bg-gray-100 min-h-screen space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="col-span-2 bg-white rounded-2xl p-4 border space-y-4">
          ...
          <ExamItem title="Computer Science Fundamentals" date="Mar 26, 2026" time="10:00 AM" students={45} duration="2 hours" />
          <ExamItem title="Data Structures & Algorithms" date="Mar 28, 2026" time="2:00 PM" students={38} duration="1.5 hours" />
          <ExamItem title="Database Systems" date="Apr 2, 2026" time="9:00 AM" students={52} duration="2 hours" />
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 border space-y-4">
          ...
          <ActivityItem text="Morgan Davis submitted Computer Science exam" time="5 minutes ago" color="bg-green-500" />
          <ActivityItem text="Tab switch detected for Casey Brown" time="12 minutes ago" color="bg-red-500" />
          <ActivityItem text="Jamie Chen started Data Structures exam" time="18 minutes ago" color="bg-blue-500" />
          <ActivityItem text="You graded Alex Thompson's submission" time="32 minutes ago" color="bg-blue-500" />
          <ActivityItem text="New exam scheduled: Database Systems" time="1 hour ago" color="bg-blue-500" />
        </div>
      </div>
